...
| **CarPart** | Car-parts store with row-locked checkout so stock can't oversell, manually verified payments, and live order notifications. Runs as a Docker stack on my VPS, deployed by CI. | [Case study](https://www.wyco-dev.com/projects/carpart) · [Live](https://carpart.wyco-dev.com) · [Source](https://github.com/Wyco68/Shop) |
